...
function printSaladRecipe(forPerson) {
  ...
  if (forPerson.eatsMeat) {
    saladRecipe.ingredients.push("chicken"); // FIXED: .push works only with arrays; not with objects. 
                                                // therefore we added it to ingredients array.
    saladRecipe.steps.push("Mix in the chicken"); // this one is good because it is added to array already.
  }
