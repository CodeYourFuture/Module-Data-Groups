...
test("given an array with both positive and negative numbers, returns the largest number", () => {
  expect(findMax([9, -10, 3, -20])).toEqual(9);
});
...
test("given an array with negative numbers, returns the closest to zero", () => {
  expect(findMax([-11, -60, -1, -6])).toEqual(-1);
});
...
test("given an array with decimal numbers, returns the largest decimal", () => {
  expect(findMax([2.5, 6.8, 1.9, 7.7])).toEqual(7.7);
});
...
test("given an array with non-number values, returns the max and ignores non-numeric values", () => {
  expect(findMax([11, "q", "h", 4, "u", 9])).toEqual(11);
});
...
test("given an array with only non-number values, returns -infinity", () => {
  expect(findMax(["v", "to", "a", "ju"])).toEqual(-Infinity);
});
