function sum(elements) {
  // Filter out non-numeric values and sum the rest
...
test("given an array with negative numbers, returns correct total sum", () => {
...
test("given an array with decimal numbers, returns correct total sum", () => {
  expect(sum([1.5, 2.5, 3.1])).toBeCloseTo(7.1);
});
