...
test("Given an array with both positive and negative numbers should return the largest number overall", () => {
  expect(findMax([-1, 2, -3, 4, -5])).toEqual(4);
});

// Given an array with just negative numbers
// When passed to the max function
// Then it should return the closest one to zero
test("Given an array with just negative numbers should return the closest one to zero", () => {
...
test(" Given an array with non-number values should return the max and ignore non-numeric values", () => {
  expect(findMax([1, "hello", 2, undefined, null])).toEqual(2);
});
...
test("Given an array with only non-number values should return the least surprising value given how it behaves for all other inputs", () => {
  expect(findMax(["hello", undefined, null, NaN])).toEqual(-Infinity);
});
