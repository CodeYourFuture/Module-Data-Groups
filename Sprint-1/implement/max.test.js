...
test("Given an array with both positive and negative numbers, it should return the closest one to zero", () =>{
...
test("Given an array contains non-number values, it should return the max and ignore non-numeric values", () =>{
